...
Full context lives at the repository root:

- [`../docs/mobile.md`](../docs/mobile.md) — routing, auth guard, state layers, design system
- [`../docs/architecture.md`](../docs/architecture.md) — how this fits with the API
- [`../docs/database-design.md`](../docs/database-design.md) — schema rationale
